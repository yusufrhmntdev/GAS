                    ...
                    <form action="" method="post">
                        <div class="form-group <?php echo form_error('nama_dept') ? 'has-error' : null?>">
                            <label> name</label>
                                ...
                                <input class="form-control" type="text" name="nama_dept" value="<?php echo $this->input->post('nama_dept') ?? $row->nama_dept?> " placeholder="fullname">
