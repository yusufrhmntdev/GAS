...
<head>
  ...
  <title>GA System || Stock Control System</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url()?>#" class="logo">
      ...
      <span class="logo-xs">
      <!-- <img src="<?php echo base_url(); ?>uploads/logo/gdsk.png" width="90px" padding-bottom =""> -->
        ...
        <ul class="nav navbar-nav">
           ...
           <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs"><b style="font-weight: 20px;">PT.Gobel Dharma Sarana Karya</b></span>
            </a>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url('uploads/user/user.png')?>" class="img-circle" width ="19px">
   <!--          <img src="<?php echo base_url('uploads/user/'.$this->session->userdata('photo')); ?>" class="img-circle" width="19px" alt="User Image"> -->
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo base_url('uploads/user/user.png')?>" class="img-circle">
               <!--  <img src="<?php echo base_url('uploads/user/'.$this->session->userdata('photo')); ?>" class="img-circle" alt="User Image">
 -->
                <p>
                <?php echo $this->fungsi->user_login()->username;?>- Admin GA
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url('uploads/user/user.png')?>" class="img-circle" width ="25px">
     ...
     <!--  <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
          ...
          <li class="treeview <?php echo $this->uri->segment(1) == 'karyawan' || $this->uri->segment(1) == 'departement' || 
          $this->uri->segment(1) == 'supplier' || $this->uri->segment(1) == 'lokasi' ? 'active' : ''?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php echo $this->uri->segment(1) == 'karyawan' ? 'class="active"' :''?>><a href="<?php echo site_url('karyawan')?>"><i class="fa fa-circle-o"></i> Karyawan</a></li>
            <li  <?php echo $this->uri->segment(1) == 'departement' ? 'class="active"' :''?>><a href="<?php echo site_url('departement')?>"><i class="fa fa-circle-o"></i> Departement</a></li>
              <li  <?php echo $this->uri->segment(1) == 'lokasi' ? 'class="active"' :''?>><a href="<?php echo site_url('lokasi')?>"><i class="fa fa-circle-o"></i> Lokasi</a></li>
            <li  <?php echo $this->uri->segment(1) == 'supplier' ? 'class="active"' :''?>><a href="<?php echo site_url('supplier')?>"><i class="fa fa-circle-o"></i> Supplier</a></li>
        ...
        <li class="treeview <?php echo $this->uri->segment(1) == 'stock' ||$this->uri->segment(1) == 'sale' ? 'active':''?>">
          ...
          <ul class="treeview-menu">
          <li  <?php echo $this->uri->segment(1) == 'sale' ? 'class="active"' :''?>><a href="<?php echo site_url('sale')?>"><i class="fa fa-circle-o"></i>ATK</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-pie-chart"></i> <span>Data Asset</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <li  <?php echo $this->uri->segment(1) == 'aset_kendaraan' ? 'class="active"' :''?>><a href="<?php echo site_url('aset_kendaraan')?>"><i class="fa fa-circle-o"></i>Kendaraan</a></li>
      
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Data Sewa</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <!-- <li  <?php echo $this->uri->segment(1) == 'sewa_bangunan' ? 'class="active"' :''?>><a href="<?php echo site_url('sewa_bangunan')?>"><i class="fa fa-circle-o"></i>Sewa Bangunan</a></li> -->
          <li  <?php echo $this->uri->segment(1) == 'sewa_kendaraan' ? 'class="active"' :''?>><a href="<?php echo site_url('sewa_kendaraan')?>"><i class="fa fa-circle-o"></i> Sewa Kendaraan</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-file"></i> <span>Legal</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <li  <?php echo $this->uri->segment(1) == 'legal' ? 'class="active"' :''?>><a href="<?php echo site_url('legal')?>"><i class="fa fa-circle-o"></i>Legal</a></li>
          </ul>
        </li>
         <!-- <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
          <li  <?php echo $this->uri->segment(1) == '' ? 'class="active"' :''?>><a href="<?php echo site_url('')?>"><i class="fa fa-circle-o"></i>Atk Report</a></li>
          </ul>
        </li> -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y') ?> <a href="#">Yusuf Rahmanto</a>.</strong> All rights
    reserved.
  </footer>
