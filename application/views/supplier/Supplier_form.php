                ...
                <div class="row">
                    ...
                    <form action="<?= site_url('supplier/proses')?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <label> Type </label>
                            <input class="form-control" type="text" name="typee" value="<?php echo $row->typee;?>" placeholder="type">
                        </div>
                         <div class="form-group">
                            
                            <label>area </label>
                            <input class="form-control" type="text" name="area" value="<?php echo $row->area;?>" placeholder="Area">
                        </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                            <label> email / website  </label>
                                <textarea name="email_website" class="form-control" placeholder="email / website"><?php echo $row->email_website?></textarea>
